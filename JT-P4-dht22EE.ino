//for JT-P4 ###########################################
//                                                    #
// Arduino IDE: set to Arduino Duemilanove with 328P  #
// v.1.0
//for JT-P4 ###########################################
...
//prepare DHT-Sensor (14 for JT-P4)###
  DHT dht(14, DHT22);
//prepare DHT-Sensor (JT-P4: (IDE Duemilanove, 328p) Port 14, Typ DHT22
...
// Start up serial####
   Serial.begin(9600);
   Serial.println("JT-P4 v.1.0");
// Start up serial###

//Prepare for Configureation###
//Serial.println("Hit <C ENTER > to configure OTAA (DevEUI, AppEUI & AppKey) or wait 10 seconds for normal operation... ");
Serial.println("C for Config or wait");
